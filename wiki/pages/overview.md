---
id: overview
title: manta — what is this and where do things live?
kind: overview
status: current
maintainer: agent
sources:
...
- `crates/manta-dsp/` — PFB channelizer, noise floor, envelope. See [[pfb-channelizer]] and [[detector-tracks]].
- `crates/manta-decode/` — keying state machine, timing, Morse decode. See [[decode-chain]].
- `crates/manta-spot/` — callsign validation, dedupe, scoring. See [[spot-validation]].
